...
public class SampleContextEventListener implements ServletContextListener {
    ...
    private static Logger LOGGER = Logger.getLogger("org.wso2.sample.is.solutionpattern");
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        try {
            if(servletContextEvent.getServletContext().getContextPath().contains("doctors.com")) {
                properties.load(servletContextEvent.getServletContext().
                        getResourceAsStream("/WEB-INF/classes/doctors.properties"));
